...
import { Smartphone, Settings, Zap, Shield, Instagram, Users, Bell, BarChart3 } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const adminNavigationItems = [
  ...
  },
  {
    ...
    url: "/admin-users",
    icon: Users,
    description: "Manage user access keys",
    roles: ["admin"],
  },
  {
    ...
    url: "/admin-notices",
    icon: Bell,
    description: "Manage user notices",
    roles: ["admin"],
  },
]
...
const userNavigationItems = [
  {
    title: "Generator",
    url: "/user-generator", // Updated from /generator to /user-generator
    icon: Zap,
    description: "Generate user agents",
    roles: ["user"],
  },
  {
    ...
    url: "/dashboard",
    icon: BarChart3,
    description: "View usage and limits",
    roles: ["user"],
  },
]
