...
export const metadata: Metadata = {
  title: "UAGen Pro - Professional User Agent Generator for iOS & Android",
  description:
    "Generate thousands of unique, professional-grade iOS and Android user agents for Instagram and Facebook. Fast, secure, and reliable user agent generation tool.",
  keywords:
    "user agent generator, iOS user agent, Android user agent, Instagram user agent, Facebook user agent, mobile user agent",
  ...
  twitter: {
    ...
    title: "UAGen Pro - Professional User Agent Generator",
    description:
      "Generate thousands of unique, professional-grade iOS and Android user agents for Instagram and Facebook.",
    images: ["/og-image.png"],
    creator: "@uagenpro",
  },
  other: {
